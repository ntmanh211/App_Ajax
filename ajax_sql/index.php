...
$sql = "SELECT * FROM post LIMIT 0,21";
...
<script>
    $(document).ready(function() {
        $('#load_more').on('click', function (event) {
            ...
            var params = {
                current: $('#my_album').children('.col-md-4').length,
                limit: 3
            };
            $.ajax({
                url: 'ajax.php',
